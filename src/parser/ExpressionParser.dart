import '../nodes/expressions/TEExpression.dart';
import '../nodes/expressions/TEVariable.dart';
...
class ExpressionParser{
  ...
  static TEExpression Parse(String text, [int endLevel=0]) {
    return (new ExpressionParser(text)).parseNormal(endLevel);
  }

  TEExpression parseNormal(int endLevel) {
    return new TEVariable("var1");
  }
}
