...
import '../../src/nodes/expressions/TEVariable.dart';
import '../../src/parser/ExpressionParser.dart';

void main() {
  group('Expression Parse Test', () {
    test('variable', () {
      var obj = ExpressionParser.Parse("var1");
      expect(obj, isA<TEVariable>());
      expect((obj as TEVariable).name, equals("var1"));
    });
  });
}
